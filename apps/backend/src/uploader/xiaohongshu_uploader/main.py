...
from src.conf import BASE_DIR, XHS_SERVER, LOCAL_CHROME_PATH, LOCAL_CHROME_HEADLESS
...
class XiaoHongShuVideo(object):
    ...
    async def upload(self, playwright: Playwright) -> None:
        ...
        page = await context.new_page()
        # 访问指定的 URL
        await page.goto("https://creator.xiaohongshu.com/publish/publish?from=homepage&target=video", wait_until='networkidle')
