...
from src.uploader.douyin_uploader.main import douyin_setup, DouYinVideo
from src.uploader.ks_uploader.main import ks_setup, KSVideo
from src.uploader.tencent_uploader.main import weixin_setup, TencentVideo
from src.utils.base_social_media import get_supported_social_media, get_cli_action, SOCIAL_MEDIA_DOUYIN, \
    SOCIAL_MEDIA_TENCENT, SOCIAL_MEDIA_KUAISHOU
from src.utils.constant import TencentZoneTypes
from src.utils.files_times import get_title_and_hashtags
...
async def main():
    ...
    parser.add_argument("platform", metavar='platform', choices=get_supported_social_media(), help="Choose social-media platform: douyin tencent kuaishou xhs")
