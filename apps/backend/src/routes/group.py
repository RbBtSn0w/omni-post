    ...
    try:
        with sqlite3.connect(db_manager.get_db_path()) as conn:
            ...
            if account_count > 0:
                return jsonify({
                    'code': 400,
                    'message': f'无法删除：该组下有 {account_count} 个账号'
                })
