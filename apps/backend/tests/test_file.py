...
class TestFile:
    ...
    def test_upload_file_with_mock(self, mock_path_class, mock_uuid):
        ...
        # Create a test file
        data = {"file": (BytesIO(b"test video content"), "test_video.mp4")}
    ...
    def test_upload_save_success(self, mock_db_manager, mock_sqlite, mock_path_class):
        ...
        with patch("src.routes.file.os.path.getsize", return_value=1024 * 1024):
            data = {"file": (BytesIO(b"test content"), "test.mp4"), "filename": "custom_name"}
    ...
    def test_get_all_files_with_uuid(self, mock_db_manager, mock_sqlite):
        ...
        mock_row1 = {
            ...
            "filename": "test.mp4",
            "filesize": 10.5,
            "file_path": "12345678-1234-5678-1234-567812345678_test.mp4",
        }
        mock_row2 = {
            "id": 2,
            "filename": "test2.mp4",
            "filesize": 20.3,
            "file_path": "87654321-4321-8765-4321-876543218765_test2.mp4",
        }
    ...
    def test_delete_file_success(self, mock_db_manager, mock_sqlite, mock_path_class):
        ...
        mock_cursor.fetchone.return_value = MagicMock(
            __getitem__=lambda s, k: mock_record[k], keys=lambda: mock_record.keys()
        )
