...
class TestPublishExecutor:
    ...
    def test_run_publish_task_douyin_success(
        self, mock_douyin, mock_task_service, mock_path, mock_videos_dir, mock_cookies_dir
    ):
        ...
        kwargs = mock_douyin.call_args[1]
        assert kwargs["title"] == "Test"
        assert kwargs["thumbnail_path"] == "thumb.jpg"
