...
export class VideoService {
    ...
    public async waitForReadiness(filePath: string): Promise<void> {
        ...
        return tracer.startActiveSpan('video.waitForReadiness', async (span) => {
            span.setAttribute('video.filePath', filePath);
            try {
    ...
    public async autoFixVideo(filePath: string): Promise<boolean> {
        const tracer = getTracer();
        return tracer.startActiveSpan('video.autoFixVideo', async (span) => {
            span.setAttribute('video.filePath', filePath);
