...
describe('runAsyncFunction dispatch', () => {
    it('should dispatch type 1 (xiaohongshu)', async () => {
        ...
        await service.xiaohongshuCookieGen('test_id', emitter, controller.signal);
    ...
    it('should dispatch type 3 (douyin)', async () => {
        ...
        await service.douyinCookieGen('test_id', new EventEmitter(), controller.signal);
    ...
    it('should dispatch type 4 (kuaishou)', async () => {
        ...
        await service.getKsCookie('test_id', new EventEmitter(), controller.signal);
    ...
    it('should dispatch type 5 (bilibili)', async () => {
        ...
        await service.bilibiliCookieGen('test_id', new EventEmitter(), controller.signal);
    ...
    it('runAsyncFunction should emit 500 for unknown type', async () => {
        ...
        await new Promise<void>((resolve) => {
            ...
            runAsyncFunction('99', 'test_id', emitter, controller.signal);
        });
