...
trigger: always_on
glob: "**/*.{py,js,vue,md}"
description: OmniPost Code Style - Quick Reference with Project Conventions
---

# OmniPost Code Style Guide

> **Scope**: Applies to all Python (`.py`) and Vue (`.vue`) files in the project.
> **Priority**: Supplemental to `copilot-instructions.md`.

> 📖 **Complete Guide**: [../../.agent/rules/style.md](../../.agent/rules/style.md)
...
## Config
- `src/core/config.py`: `BASE_DIR`, `VIDEOS_DIR` (Absolute).
